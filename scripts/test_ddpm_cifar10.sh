...
ddpm_path_1='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_1/checkpoints/ddpmv2-vae-epoch=999-loss=0.0113.ckpt'
ddpm_path_2='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_2/checkpoints/ddpmv2-vae-epoch=999-loss=0.0097.ckpt'
ddpm_path_3='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_3/checkpoints/ddpmv2-vae-epoch=999-loss=0.0112.ckpt'
ddpm_path_4='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_4/checkpoints/ddpmv2-vae-epoch=999-loss=0.0155.ckpt'
ddpm_path_5='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_5/checkpoints/ddpmv2-vae-epoch=999-loss=0.0173.ckpt'
ddpm_path_6='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_6/checkpoints/ddpmv2-vae-epoch=999-loss=0.0128.ckpt'
ddpm_path_7='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_7/checkpoints/ddpmv2-vae-epoch=999-loss=0.0112.ckpt'
ddpm_path_8='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_8/checkpoints/ddpmv2-vae-epoch=999-loss=0.0068.ckpt'
ddpm_path_9='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_9/checkpoints/ddpmv2-vae-epoch=999-loss=0.0108.ckpt'
ddpm_path_10='/cluster/work/vogtlab/Group/jogoncalves/results/cifar10/seed_10/checkpoints/ddpmv2-vae-epoch=999-loss=0.0128.ckpt'
