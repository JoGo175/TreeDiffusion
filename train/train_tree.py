...
def run_tree(trainset, trainset_eval, testset, configs, device):
	...
	max_depth = len(configs['training']['bottom_up_channels']) - 1
	...
	while grow and growing_iterations<150:
		...
		gen_test_small = get_gen(testset, configs, shuffle=False, validation=True, smalltree=True, smalltree_ind=ind_test)
	...
	# print number of parameters and save to wandb
