...
def main():
    ...
    parser.add_argument('--num_clusters_data', type=int, help='the number of clusters of the tree')
    ...
    parser.add_argument('--skip_con_transformation', type=lambda x: bool(distutils.util.strtobool(x)), help='whether to use skip connections in transformations')
    ...
    parser.add_argument('--config_name', default='cifar10', type=str, choices=['mnist', 'fmnist', 'news20', 'omniglot','cifar10', 'cifar100', 'celeba'], help='the override file name for config.yml')
